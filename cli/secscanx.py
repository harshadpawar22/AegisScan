#!/usr/bin/env python3
"""
AegisScan CLI - Command Line Interface for AI-Assisted Vulnerability Assessment
"""
...
class AegisScanCLI:
    def __init__(self, api_url="http://localhost:5000/api"):
        ...
        self.session.headers.update({
            ...
            'User-Agent': 'AegisScan-CLI/1.0'
        })

    def print_banner(self):
        """Print AegisScan banner"""
        banner = f"""
{Fore.CYAN}
███████╗███████╗ ██████╗███████╗ ██████╗ █████╗ ███╗   ██╗██╗  ██╗
██╔════╝██╔════╝██╔════╝██╔════╝██╔════╝██╔══██╗████╗  ██║╚██╗██╔╝
...
{Fore.GREEN}Version 1.0 | Open Source Security Scanner{Style.RESET_ALL}
    ...
    def make_request(self, endpoint, data=None, method="GET"):
        ...
        try:
            ...
            self.print_status("Cannot connect to AegisScan server. Is it running?", "ERROR")
            return None
...
def main():
    parser = argparse.ArgumentParser(
        description="AegisScan CLI - AI-Assisted Vulnerability Assessment Tool",
