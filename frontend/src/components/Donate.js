    ...
    <Box sx={{ p: 3 }}>
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Typography variant="body1" paragraph>
            AegisScan is an open-source project created by <strong>Yashab Alam</strong>, founder and CEO of ZehraSec. 
      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body1" paragraph>
            AegisScan is developed by <strong>Yashab Alam</strong>, founder and CEO of ZehraSec, 
      ...
      <Box sx={{ textAlign: 'center', mt: 4, p: 3, backgroundColor: 'primary.main', color: 'white', borderRadius: 2 }}>
        ...
        <Typography variant="h5" gutterBottom>
          Thank You for Supporting AegisScan!
        </Typography>
        <Typography variant="body1">
          Every contribution helps make AegisScan better for security professionals, 
