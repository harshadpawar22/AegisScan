  ...
  const scanTypes = [
    {
      ...
      usage: "AegisScan scan subdomain example.com",
    ...
    },
    {
      ...
      usage: "AegisScan scan web https://example.com",
    ...
    },
    {
      ...
      usage: "AegisScan scan full example.com",
      ...
      <Grid container spacing={3}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                  ...
                  <Paper sx={{ p: 2, bgcolor: 'grey.900', color: 'grey.100', fontFamily: 'monospace', fontSize: '0.875rem' }}>
                    <div># Install AegisScan</div>
                    <div>pip install -e .</div>
                    <br />
                    <div># Show help</div>
                    <div>AegisScan --help</div>
                    <br />
                    <div># Basic scan</div>
                    <div>AegisScan scan subdomain example.com</div>
                    <br />
                    <div># Scan with output file</div>
                    <div>AegisScan scan ports example.com -o results.json</div>
                    <br />
                    <div># Generate report</div>
                    <div>AegisScan report results.json --format pdf</div>
                  </Paper>
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Paper sx={{ p: 2, bgcolor: 'grey.900', color: 'grey.100', fontFamily: 'monospace', fontSize: '0.875rem' }}>
                    ...
                    <div>AegisScan --learning scan web https://example.com</div>
                    <br />
                    <div># Custom timeout and threads</div>
                    <div>AegisScan scan ports example.com --timeout 60 --threads 20</div>
                    <br />
                    <div># Verbose output</div>
                    <div>AegisScan -v scan full example.com</div>
                    <br />
                    <div># Save to specific project</div>
                    <div>AegisScan scan subdomain example.com --project "client-audit"</div>
                  </Paper>
                </Grid>
              </Grid>
            </AccordionDetails>
        ...
        <Grid item xs={12}>
          <Alert severity="info">
            ...
            <Typography variant="body2" paragraph>
              AegisScan is an open-source project. If you encounter issues or need additional help:
            </Typography>
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              <Button
                ...
                size="small"
                startIcon={<CodeIcon />}
                href="https://github.com/AegisScan/AegisScan"
                target="_blank"
              >
                GitHub Repository
              </Button>
              <Button
                ...
                size="small"
                startIcon={<BugIcon />}
                href="https://github.com/AegisScan/AegisScan/issues"
                target="_blank"
              >
                Report Issues
              </Button>
              <Button
                ...
                size="small"
                startIcon={<HelpIcon />}
                href="https://github.com/AegisScan/AegisScan/discussions"
                target="_blank"
              >
                Community Support
              </Button>
