...
class AIAssistant:
    ...
    def chat_response(self, message, context=None):
        ...
        try:
            ...
            system_message = """You are AegisScan AI Assistant, a cybersecurity expert that helps with vulnerability assessment and penetration testing. 
    ...
    def _fallback_chat_response(self, message, context=None):
        ...
        responses = {
            "help": "AegisScan offers subdomain enumeration, port scanning, vulnerability assessment, and automated reporting. Use the web interface or CLI to get started.",
