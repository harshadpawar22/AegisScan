...
class ReportGenerator:
    ...
    def generate_report(self, scan_data, report_format='html'):
        ...
        try:
            ...
            if report_format.lower() == 'pdf':
                ...
                filepath = os.path.join('/workspaces/AegisScan/reports', filename)
    ...
    def _generate_pdf_report(self, scan_data, filepath):
        ...
        # Title page
        story.append(Paragraph("AegisScan Security Assessment Report", self.title_style))
...
<head>
    ...
    <title>AegisScan Security Assessment Report</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>This report was generated by AegisScan - AI-Assisted Vulnerability Assessment Tool</p>
