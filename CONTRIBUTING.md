...
Thank you for your interest in contributing to AegisScan! This document provides guidelines and information for contributors.
...
```bash
# Clone your fork
git clone https://github.com/YOUR-USERNAME/AegisScan.git
cd AegisScan
...
AegisScan is a security tool, so security considerations are paramount:
...
2. Email dev.harshadpawar69.com with details
...
By contributing to AegisScan, you agree that your contributions will be licensed under the MIT License.

---

Thank you for contributing to AegisScan! Your efforts help make cybersecurity tools more accessible and effective for everyone.
